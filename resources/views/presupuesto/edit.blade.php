        ...
        <div class="row justify-content-left">
            <div class="col-sx-12 col-sm-12 col-lg-8">
                <div class="card card-default">
                    <div class="card-header">Editando Presupuesto</div>
                    <div class="card-body">
                        {{ Form::open(['action' => route('presupuesto.update', $presupuesto->id), 'method' => 'PUT', 'url' => 'presupuesto/'.$presupuesto->id, 'class' => 'form-horizontal']) }}
                        <div class="form-group row">
                            {!! Form::label('presta_nombre', 'Nombres', ['class' => 'col-sm-2 col-form-label']) !!}
                            <div class="col-sm-6">
                                {!! Form::text('presta_nombre', $presupuesto->presta_nombre, ['class' => 'form-control
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::textarea('presta_descripcion',$presupuesto->presta_descripcion, ['class' => 'form-control
                            ...
                            <div class="form-group row">
                                {!! Form::label('presta_descripcion', 'Descripcion', ['class' => 'col-sm-2 col-form-label']) !!}
                                <div class="col-sm-5">
                                    {!! Form::text('presta_valor',$presupuesto->presta_valor, ['class' => 'form-control
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <a href="{{ route('presupuesto.index') }}" style="text-decoration:none">
