    ...
    <body class="hold-transition sidebar-mini">
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-dark navbar-cyan">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="{{ route('presupuesto.index') }}" class="nav-link"><i class="fas fa-clipboard mr-2"></i>Presupuesto</a>
                    </li>
                </ul>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="uploads/avatars/{{ Auth()->user()->avatar ?? 'uploads/avatars/default.png' }}"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a class="brand-link" href="{{ url('/') }}">
                <img src="{{ asset('images/licandent_logo.jpg') }}"
                     alt="licanDent Logo"
                     class="brand-image img-circle elevation-3"
                     style="opacity: .8">
                {{--<i class="fas fa-tooth brand-image"></i>--}}
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; {{ now()->year }} <a href="https://github.com/m4ury" style="text-decoration:none">
